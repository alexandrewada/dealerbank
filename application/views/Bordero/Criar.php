...
       <td id='vencimento' class='vencimento' contenteditable="true"></td>
        ...
        <td class='text-center nome_sacado' style="font-size: 11px;"></td>
...
<hr>
	...
	<div class='col-md-4'> 
		...
		<div class="row">
			...
			<div class='col-md-6 form-group'>
				...
				<label>
					Data da operação
					<input type="date" value="<?=date('Y-m-d');?>" name="data_operacao" class="form-control">
				</label>
  ...
  <datalist id="sacados">
    ...
    <?endforeach;?>
	  ...
	  <form class="ajax-post" action="<?=base_url('bordero/criar');?>" >
