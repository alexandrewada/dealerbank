...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Dados sobre a Cliente</h2>
                  
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br>
                    <form   action='<?=base_url('clientes/cadastrar');?>'' method='POST' class="form-horizontal form-label-left ajax-post" >
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">IM<span class="required">*</span>
                        </label>
                        <div class="col-md-4 col-sm-6 col-xs-12"> 
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nome Empresa<span class="required">*</span>
                        </label>
                        <div class="col-md-4 col-sm-6 col-xs-12">
