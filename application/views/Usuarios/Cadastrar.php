    ...
    $("input[name='cnpj']").blur(function(){
      ...
      $.get(base_url+"webservice/cnpj/"+cnpj,function(e){
      	  ...
      	  if(e.erro != 1){
	          ...
	          $("input[name='tipo_situacao']").val(e.tipo);
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form   action='<?=base_url('usuarios/cadastrar');?>'' method='POST' class="form-horizontal form-label-left ajax-post" >
                      ...
                      <div data-tipo='pf' class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Data Nascimento
                        </label>
                        <div class="col-md-2 col-sm-6 col-xs-12">
                      ...
                      <div data-tipo='pj' class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">IE
                        </label>
                        <div class="col-md-4 col-sm-6 col-xs-12"> 
                      ...
                      <div data-tipo='pj' class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">IM
                        </label>
                        <div class="col-md-4 col-sm-6 col-xs-12"> 
                          <input type="text" name='im'  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <input type="password" name='senha' value="<?=rand(1000000,10000000);?>"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12">
                          <input type="text" name='celular'  data-inputmask="'mask': '(99) 99999-9999'"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div data-tipo='pj'  class="form-group">
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12">
                          <input type="text" name='tipo_situacao'  class="form-control col-md-7 col-xs-12" readonly="true">
                        </div>
                      </div>
