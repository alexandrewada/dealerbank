 ...
 -->
		...
		<table>
			<tbody>
				...
				<tr>
					<td class="campo">Tipo Diferencial de Compra:</td>
					<td class="valor"><?=($bordero_calculo->dif_a > $bordero_calculo->dif_b) ? 'NOMINAL' : 'EFETIVO';?></td>
				</tr>
				...
				<tr>
					<td class="campo">Ressarc IOF Fixo:</td>
				
					<td class="valor"><?=$bordero_calculo->iof_a;?></td>
				</tr>


				<tr>
					<td class="campo">Ressarc IOF Variável:</td>
				
					<td class="valor"><?=$bordero_calculo->iof_b;?></td>
				</tr>


				<tr>
					<td class="campo">Ressarc IOF Total:</td>
				...
				<tr>
					...
					<td  class="valor"><?=$bordero_calculo->valor_liquido-$bordero_informativo->tarifas;?></td>
				</tr
